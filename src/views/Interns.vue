                    ...
                    <b-card-body>
                        <b-card-text style="text-align: left">
                            ...
                            <b-row class="pb-3">
                                <b-col sm="12">
                                    <p>
                                        ...
                                        <a href="https://suzukisan.herokuapp.com/">Demo</a>[TestUser]email: user1@example.com, password: password<br>
                                        <strong>担当</strong><br>
                                        フロントエンド<br>
                                        サーバーサイド<br>
                                        <strong>環境・言語</strong><br>
                            ...
                            <b-row class="pb-3">
                                <b-col sm="12">
                                    <p>
                                        ...
                                        <strong>環境・言語</strong><br>
                                        【言語・フレームワーク】<br>
                                        Ruby | Ruby on Rails | Swift | BootStrap | HTML | CSS | JavaScript | jQuery <br>
                                        【ミドルウェア】<br>
                                        Postgres | Docker <br>
                                        【クラウドサービス】<br>
                                        Firebase | Firestore
                                ...
                                <div class="more-interns" style="display:none">
                                    <b-col sm="12">
                                        <p>
                                            ...
                                            2018年12月<br>
                                            <strong>内容</strong><br>
                                            研究用ツール (Androidアプリ)のUI修正及び画像処理の機能追加<br>
                                            <strong>担当</strong><br>
                                            ネイティブアプリ(Android)<br>
                                            <strong>環境・言語</strong><br>
                                            【言語・フレームワーク】<br>
                            ...
                            <div style="text-align: center">
                                <b-button class="intern-more-button" @click="openClose()">more</b-button>
                            </div>
                        </b-card-text>
                    </b-card-body>
                </b-card>
