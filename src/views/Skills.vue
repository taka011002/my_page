        ...
        <b-card no-body class="overflow-hidden">
          <b-card-body>
            <b-card-text style="text-align: left">
              ...
              <p>
                Ruby(Ruby on Rails) | Swift(iOS Application) | Go | Python |
                Kotlin(Android) | Java(Android, Spring Boot) | C#(ASP.NET Core,
                Unity) | PHP(Laravel) | JS(jQuery, Vue, Node-RED) | HTML | CSS
              </p>
              ...
              <p>
                EC2 | ECS | ECR | EB | S3 | RDS | CodePipeline | CodeBuild |
                Kinesis Data Firehose | Athena | QuickSight Lambda | Cloudwatch
              </p>
