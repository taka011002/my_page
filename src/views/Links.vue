                            ...
                            <b-row>
                                <b-col cols="3">
                                    <b-link href="https://github.com/taka011002">
                                        <b-img src="icons/github_logo.png" style="max-width: 100px;"></b-img>
                                    </b-link>
                                </b-col>
                                <b-col cols="3">
                                    <b-link href="https://qiita.com/takahiro_ishitsuka">
                                        <b-img src="icons/qiita-square.png" style="max-width: 100px;"></b-img>
                                    </b-link>
                                </b-col>
                                <b-col cols="3">
                                    <b-link href="https://twitter.com/taka0110_">
                                        <b-img src="icons/twitter_logo.png" style="max-width: 100px;"></b-img>
                                    </b-link>
                                </b-col>
                                <b-col cols="3">
